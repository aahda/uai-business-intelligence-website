...
const PowerBi = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 256 342">
    ...
    <mask id="SVGvCV5wclL" fill="#fff">
      <use href="#SVGvAvgNc4T" />
    </mask>
    <path
      fill="url(#SVGCdghnblF)"
      d="M256 0v341.333H142.222V0z"
      mask="url(#SVGvCV5wclL)"
    />
    <path
      fillOpacity=".2"
